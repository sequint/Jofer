        ...
        <div className="container px-5 my-5">
          <div className="row gx-5">
            ...
            <div className="col-lg-4 mb-5 mb-lg-0">
              ...
              <h2 className="h4 fw-bolder">Features</h2>
              <ul className="featuresList">
                <li className="mb-2 featuresLiItem">
                  ...
                  <span className="ps-3">Easy Drag & Drop Interface</span>
                </li>
                <li className="mb-2 featuresLiItem">
                  ...
                  <span className="ps-3">Job Manager Tool</span>
                </li>
                <li className="mb-2 featuresLiItem">
                  <svg
                    viewBox="0 0 24 24"
                  ...
                  <span className="ps-3">Negotiate Your Salary</span>
                </li>
                <li className="mb-2 featuresLiItem">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-lines-fill" viewBox="0 0 16 16">
                    <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5 6s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zM11 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm.5 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4zm2 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2z" />
                  </svg>
                  <span className="ps-3">Refine Your Skills</span>             
                  </li>
                <li className="mb-2 featuresLiItem">
                  ...
                  <span className="ps-3">Bulk Decline</span>
                </li>
                <li className="mb-2 featuresLiItem">
                  ...
                  <span className="ps-3">Filtering System</span>
                </li>
                <li className="mb-2 featuresLiItem ">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-three-dots" viewBox="0 0 16 16">
                    <path d="M3 9.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z" />
                  </svg>
                  <span className="ps-3">And More</span>
                </li>
              </ul>
            </div>
